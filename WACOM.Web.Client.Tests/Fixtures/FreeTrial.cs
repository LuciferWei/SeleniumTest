    ...
    public class FreeTrial : BaseFixture
    {
        ...
        public void VerifyChangeCreditPriceCurrency()
        {
            this.CreateSeleniumTestContext().Run(driver =>
            {
                ...
                IWebElement priceSpan = driver.FindElement(By.CssSelector("section.wa-sectionFreeTrialB")).FindElement(By.CssSelector("span[class='stored-price no-convert price-data'][data-pricekey='monetaryCredit.freeTrial']"));
                ...
                priceSpan = driver.FindElement(By.CssSelector("section.wa-sectionFreeTrialB")).FindElement(By.CssSelector("span[class='stored-price no-convert price-data'][data-pricekey='monetaryCredit.freeTrial']"));
