    ...
    public class AzureStatus:BaseFixture
    {
        ...
        public void SwitchBetweenHistoryAndCurrentStatus()
        {
            this.CreateSeleniumTestContext().Run(driver =>
            {
                ...
                Assert.IsFalse(driver.FindElement(By.ClassName("wa-tableDynamic-container")).Displayed,"DynamicTableCollection is visable in History tab");
                ...
                Assert.IsTrue(driver.FindElement(By.ClassName("wa-tableDynamic-container")).Displayed, "DynamicTableCollection is not visable in Current Status tab");
