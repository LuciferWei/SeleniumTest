    ...
    public class HomePageFixture : BaseFixture
    {
        ...
        public void ChangeOneLanguageOnHomePage()
        {
            this.CreateSeleniumTestContext().Run(driver =>
            {
                ...
                Assert.AreEqual("Molnet för det moderna företaget", driver.FindElement(By.TagName("h1")).Text, "Page H1 text incorrect");
                ...
                Assert.AreEqual("The cloud for modern business", driver.FindElement(By.TagName("h1")).Text, "Page H1 text incorrect");
        ...
        public void ChangeAllLanguagesOnHomePage()
        {
            this.CreateSeleniumTestContext().Run(driver =>
            {
                ...
                foreach (string lang in langs)
                {
                    ...
                    Assert.AreEqual(homePageH1TextByLang[lang], driver.FindElement(By.TagName("h1")).Text, "Page H1 text incorrect for: " + homePageH1TextByLang[lang]);
                }
